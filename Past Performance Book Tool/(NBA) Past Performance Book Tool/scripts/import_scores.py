...
def calculate_averages(team_data_pts, team_data_allowed):
    ...
    return (
        ...
        f"{average_72_allowed:.2f}" if not pd.isna(average_72_allowed) else ""
    )
