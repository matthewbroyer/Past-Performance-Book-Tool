...
def clean_data(year_data, year):
    ...
    # Remove periods (".") from "visitor" and "home" columns
    year_data['Visitor'] = year_data['Visitor'].str.replace(".", "")
    year_data['Home'] = year_data['Home'].str.replace(".", "")

    # Remove periods (".") from "visitor" and "home" columns
    year_data['Visitor'] = year_data['Visitor'].str.replace("Montreal Canadiens", "Montréal Canadiens")
    year_data['Home'] = year_data['Home'].str.replace("Montreal Canadiens", "Montréal Canadiens")
